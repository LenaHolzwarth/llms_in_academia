...
Once a preprint is published in a journal, it is replaced with its published version in PMC\footnote{This is an assumption based on the observation that there are no papers with the same PMC-ID }.
...
\begin{itemize}
    ...
    \item \textbf{PMC-ID}: unique identifier for every paper in PMC. This is a way to prevent papers being listed twice (e.g. once as preprint, once as published version)
