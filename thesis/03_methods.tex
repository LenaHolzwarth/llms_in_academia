...
\begin{figure}[htbp]
    ...
    \caption{Examples of words with noticeable frequency changes in abstracts from PMC after the release of ChatGPT. The left column shows the word's observed frequency $q$, the right column shows the resulting lower bound estimates. While ``potential'' has a strong increase in frequency (Panel \textbf{a}), this only yields a lower bound estimate of below 10\% (Panel \textbf{b}). ``Delve'' has a very strong increase in frequency up to mid-2024, followed by a steep decrease (Panel \textbf{c})}
